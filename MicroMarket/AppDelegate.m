...
{
    // Load the data model here.
    self.dataController = [[MarketDataController alloc] init];
...
//    }
    ...
    for(UINavigationController * navigationController in tabBarController.viewControllers)
    {
        ...
        [viewController setDataController:self.dataController];
...
//    }
//    
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MicroMarket.sqlite"];
//    
//    NSError *error = nil;
